...
> **Статус: на железе ещё не проверено.** Все ветки кода покрыты 212
> автотестами с подменёнными DMI, sysfs и ACPI-транспортом, сборка
> воспроизводима — но живой Legion Go 1 плагин ещё не запускал. Если он у вас
> есть, [диагностический скрипт](#диагностический-скрипт) за десять секунд
> скажет, какой бэкенд даёт ваше ядро; пришлите его вывод в issue.
