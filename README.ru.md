...
- **Язык:** English / Русский, переключается внизу панели («Язык» / «Language»)
  и запоминается в настройках плагина. При первом запуске берётся язык клиента
  Steam.
...
1. Скачайте `LTDP-<версия>.zip` из
   [Releases](https://github.com/LORDEL/LTDP/releases) и скопируйте на консоль (флешка, `scp`, Steam
